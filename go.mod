...
require (
	...
	github.com/synadia-labs/tne v0.0.0-20240904014207-04d131b71f6e // indirect
...
replace github.com/k3s-io/kine => github.com/synadia-labs/kine-tne v0.0.0-20241007162844-6815bbbd6fcd
